...
connect_debug_port u_ila_0/probe0 [get_nets [list {opcode_IBUF[0]} {opcode_IBUF[1]}]]
...
connect_debug_port u_ila_0/probe3 [get_nets [list {A_IBUF[0]} {A_IBUF[1]} {A_IBUF[2]} {A_IBUF[3]}]]
create_debug_port u_ila_0 probe
