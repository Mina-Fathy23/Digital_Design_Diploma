...
HD_PWD='D:/Mina/Digtal Design Diploma/Session_4/Assignment_4/Q3.v/Q3/Q3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TDM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TDM.tcl -notrace
