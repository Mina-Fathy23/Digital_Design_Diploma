...
HD_PWD='D:/Mina/Digtal Design Diploma/Session_4/Assignment_4/Q2/Q2/Q2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1_S.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP48A1_S.tcl
