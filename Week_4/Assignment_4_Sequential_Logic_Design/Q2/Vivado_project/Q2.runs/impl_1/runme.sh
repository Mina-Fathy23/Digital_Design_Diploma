...
HD_PWD='D:/Mina/Digtal Design Diploma/Session_4/Assignment_4/Q2/Q2/Q2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1_S.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP48A1_S.tcl -notrace
